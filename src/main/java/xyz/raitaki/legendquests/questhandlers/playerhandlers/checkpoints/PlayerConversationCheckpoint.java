...
public class PlayerConversationCheckpoint extends PlayerCheckpoint {
    ...
    public PlayerConversationCheckpoint(PlayerQuest quest, CheckPointTypeEnum type, boolean completed, String text, String npcName, String acceptText, String declineText) {
    ...
    public void sendMessage(){
        ...
        TextUtils.sendCenteredMessage(player, "&m                                                                    ");
